...
<Steps>
  <Step title="Sign Up">
    Create your ReplyIQ account at [app.replyiq.com](https://app.replyiq.com)
  </Step>
  <Step title="Configure AI Models">
    Set up your preferred AI providers (OpenAI, Claude, etc.) in the dashboard
  </Step>
  ...
  <Step title="Start Generating Replies">
    Navigate to any social media platform and start generating AI-powered replies!
  </Step>
</Steps>
